...
class Mdl_order_items extends CI_Model {

function __construct() {
parent::__construct();
}

function _delete_order($order_id) {
...
function get_order_items($order_id) {
	...
	$sql ='select oi.order_id, oi.id,si.item_price, si.small_pic, oi.quantity, si.item_name, sic.item_colour, sis.item_size 
	from 
	order_items as oi
